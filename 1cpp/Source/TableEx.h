...
private:
	...
	static int CallOriginalMethod_SourceTable(CBLContext* pCont, class CValue **ppValue);

	static int procAddAllMDInnerFormsName(class CString &str,long l1,long l2,enum PageType pt);
