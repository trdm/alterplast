...
private:
	...
	class TColumnsMapPair : public allocator<TColumnsMapPair>
	{
	public:
		int nSrcCol;
		int nDestCol;
	};
	typedef vector<TColumnsMapPair,TColumnsMapPair> TColumnsMap;
