...
public:
	DWORD buf1[7];
	CDocTransacter* m_pDocTransacter;
	DWORD buf2[16];
	CDocSet* m_pDocSet;
	DWORD data1;
...
public:
	...
	CString m_strCtrlTitle; //CControlID::m_Title
	int m_Flag14; //0x6C
	int m_Flag15; //0x70
	int m_Flag16; //0x74
	int m_Flag17; //0x78
...
//	CObArray mm_ctrlList;
	...
	CControlList m_cControlList;
	CEditDoc* m_pEditDoc; //[224]
	CFont m_cFont;
	CGetFieldsArray m_cGetFieldsArray1;
	CGetFieldsArray m_cGetFieldsArray2;
	DWORD m_Flag237;
	DWORD m_Flag238;
	DWORD m_Flag239;
	DWORD m_Flag240;
	...
	CBLModule7* m_pBLModule; //0x11B

	DWORD bufGetDoc7[0x01]; //оставляем для доступа к атрибутам наследников от CGetDoc7
/*
...
public:
	CStringArray m_FlagUnk1;
//	DWORD m_FlagUnk2;
//	DWORD m_FlagUnk3;
//	DWORD m_FlagUnk4;
//	DWORD m_FlagUnk5;
	CByteArray m_FlagUnk6;
//	DWORD m_FlagUnk7;
//	DWORD m_FlagUnk8;
//	DWORD m_FlagUnk9;
//	DWORD m_FlagUnk10;
	CFormAllCtrlsContext* m_pForm;
	CGetDoc7 *m_pDocFC; // CReportForm / CSubcForm
...
public:
// где-то ошибка (в одном из двух вариантов)
// Вариант АльФ-а
//	CPtrArray m_FlagUnk1;
//	CByteArray m_FlagUnk6;
// Вариант 1С++
	CPtrArray m_FlagUnk1;
	CByteArray m_FlagUnk6;
