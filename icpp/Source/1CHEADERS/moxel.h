...
//class CList<class CSheetDrawing *,class CSheetDrawing *>;
...
public:
	...
	int  LookupProperty(enum CSheetString,CString &)const;	//409
...
public:
	...
	void  DeleteName(CString const &);	//141
	...
	class CSortArray<int,int,CString,char const *> const &  GetMasks(void)const;	//263
	...
	int  LookupName(CString const &,class CSheetNamedItem &)const;	//407
...
public:
	...
	static char const *  ReadClipboardString(char const *,CString &);	//610
	...
	static CString   ReplaceString(char const *,char const *,unsigned long,char const *);	//631
	...
	void  SetName(CString const &,class CSheetNamedItem const &);	//681
...
public:
	...
	CString const &  GetWindowKey(void)const;	//344
...
public:
	...
	CString   DisplayString(void)const;	//144
...
//	struct std::__hashtable_const_iterator<struct std::pair<CString const ,class CSheetNamedItem>,CString,struct CSheetNames::strihash,struct std::select1st<struct std::pair<CString const ,class CSheetNamedItem> >,struct CSheetNames::strieq,class std::__alloc<1,0> >   begin(void)const;	//776
	void  clear(void);	//787
//	struct std::__hashtable_const_iterator<struct std::pair<CString const ,class CSheetNamedItem>,CString,struct CSheetNames::strihash,struct std::select1st<struct std::pair<CString const ,class CSheetNamedItem> >,struct CSheetNames::strieq,class std::__alloc<1,0> >   end(void)const;	//788
	void  erase(CString const &);	//789
//	struct std::__hashtable_const_iterator<struct std::pair<CString const ,class CSheetNamedItem>,CString,struct CSheetNames::strihash,struct std::select1st<struct std::pair<CString const ,class CSheetNamedItem> >,struct CSheetNames::strieq,class std::__alloc<1,0> >   find(CString const &)const;	//790
//	struct std::__hashtable_const_iterator<struct std::pair<CString const ,class CSheetNamedItem>,CString,struct CSheetNames::strihash,struct std::select1st<struct std::pair<CString const ,class CSheetNamedItem> >,struct CSheetNames::strieq,class std::__alloc<1,0> >   find_item(class CSheetNamedItem const &)const;	//791
	void  insert(CString const &,class CSheetNamedItem const &);	//792
};
...
public:
	...
	CString const &  GetName(void)const;	//268
...
public:
	...
	CString   GetSelectionName(void);	//316
...
protected:
	...
	int  IsTextOnBar(CString &,enum CSheetView::BarTextState &);	//392
...
public:
	void  OnApplyBarText(CString);	//429
protected:
...
protected:
	...
	int  OnInactiveMouse(class CSheetDrawing *,CString &);	//479
...
public:
	...
	void  SetSelectionName(CString);	//709
protected:
