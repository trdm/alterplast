...
public:
	...
	void  DeleteName(CString const &);	//127
	...
	class CSortArray<int,int,CString,char const *> const &  GetMasks(void)const;	//209
	...
	int  LookupName(CString const &,class CSheetNamedItem &)const;	//314
...
public:
	...
	static char const *  ReadClipboardString(char const *,CString &);	//355
	...
	static CString   ReplaceString(char const *,char const *,unsigned long,char const *);	//373
	...
	void  SetName(CString const &,class CSheetNamedItem const &);	//405
...
public:
	...
	int  LookupProperty(enum CSheetString,CString &)const;	//316
...
public:
	...
	CString const &  GetWindowKey(void)const;	//274
...
public:
	...
	CString   DisplayString(void)const;	//130
...
public:
	...
	struct std::__hashtable_const_iterator<struct std::pair<CString const ,class CSheetNamedItem>,CString,struct CSheetNames::strihash,struct std::select1st<struct std::pair<CString const ,class CSheetNamedItem> >,struct CSheetNames::strieq,class std::__alloc<1,0> >   begin(void)const;	//469
	void  clear(void);	//479
	struct std::__hashtable_const_iterator<struct std::pair<CString const ,class CSheetNamedItem>,CString,struct CSheetNames::strihash,struct std::select1st<struct std::pair<CString const ,class CSheetNamedItem> >,struct CSheetNames::strieq,class std::__alloc<1,0> >   end(void)const;	//480
	void  erase(CString const &);	//481
	struct std::__hashtable_const_iterator<struct std::pair<CString const ,class CSheetNamedItem>,CString,struct CSheetNames::strihash,struct std::select1st<struct std::pair<CString const ,class CSheetNamedItem> >,struct CSheetNames::strieq,class std::__alloc<1,0> >   find(CString const &)const;	//482
	struct std::__hashtable_const_iterator<struct std::pair<CString const ,class CSheetNamedItem>,CString,struct CSheetNames::strihash,struct std::select1st<struct std::pair<CString const ,class CSheetNamedItem> >,struct CSheetNames::strieq,class std::__alloc<1,0> >   find_item(class CSheetNamedItem const &)const;	//483
	void  insert(CString const &,class CSheetNamedItem const &);	//484
};
...
public:
	...
	CString const &  GetName(void)const;	//213
