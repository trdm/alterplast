...
protected:
	void  CopyBack(CString &,int)const;	//64
public:
	void  CreateLine(int,char *,int)const;	//65
protected:
	void  CutEndSpaces(CString &);	//75
public:
...
public:
	...
	int  FastGetLine(int,CString &,int)const;	//93
...
public:
	...
	void  GetSelectedText(CString &)const;	//154
...
protected:
	...
	void  _CreateFullText(CString &)const;	//376
...
protected:
	...
	int  AnalizeStrForCurr(CString &)const;	//33
	int  AnalizeStrForNext(CString &)const;	//34
...
protected:
	...
	void  FormatSel(CString *,CString *,int)const;	//106
public:
	void  GetCurrentWord(CString &);	//111
	class CTextDocument *  GetDocument(void)const;	//114
protected:
	int  GetLeftPos(void);	//120
public:
	int  GetMaxLineLen(void);	//128
	void  GetSelText(CString &);	//153
...
protected:
	...
	void  OnReplaceAll(CString,CString,int,int,int);	//270
	void  OnReplaceSel(CString,CString,int,int);	//271
public:
...
protected:
	...
	void  ReplaceLoop(CString,int,int);	//325
...
public:
	...
	CString   GetLineAsString(int);	//123
...
protected:
	virtual int  CalcExpr(char const *,CString &);	//37
public:
