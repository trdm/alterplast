...
//		InfoEventHandlers() : pBLCont(NULL), nNumMethOfCall(-1)  {}
	...
	typedef std::list<InfoEventHandlers> LIST;
	typedef std::list<InfoEventHandlers>::iterator ITER;
	typedef std::list<InfoEventHandlers>::const_iterator CONST_ITER;
	typedef std::list<InfoEventHandlers>::reverse_iterator REVERSE_ITER;
