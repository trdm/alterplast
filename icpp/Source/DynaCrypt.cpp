...
void CDynaCrypt::EncryptString(const CString &str, const CString &key, CString &rValue)
{	
	int kl,sl,dl;
...
int  CDynaCrypt::CallAsFunc(int iMethNum,CValue & rValue,CValue * *ppValue)
{
	int rc=1;
...
int  CDynaCrypt::GetParamDefValue(int iMethodNum,int iParamNum,CValue * pDefValue)const
{
	return 0;
}


int  CDynaCrypt::CallAsProc(int iMethNum,CValue * * ppValue)
{
  return -1;
}
...
void  CDynaCrypt::GetExactValue(CValue & vParam)
{
...
int  CDynaCrypt::GetPropVal(int i,CValue &rValue)const
{
	return NULL;
}
...
CType   CDynaCrypt::GetValueType(void)const
{
	return CType(100);
}
...
void  CDynaCrypt::InitObject(CType const & tType)
{
...
int  CDynaCrypt::SaveToString(CString & csStr)
{	
	return 1;
}
...
int  CDynaCrypt::SetPropVal(int iPropNum,CValue const & vValue)
{
	return 0;
}