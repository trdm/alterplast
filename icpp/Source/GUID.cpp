...
int  CGUID::CallAsFunc(int iMethNum,CValue & rValue,CValue * *ppValue)
{
    int ret = 0;
	switch(iMethNum)
  {
...
int  CGUID::CallAsProc(int iMethNum,CValue * * ppValue)
{
    int ret = 0;
	switch(iMethNum)
  {
...
int  CGUID::GetParamDefValue(int iMethodNum,int iParamNum,CValue * pDefValue)const
{	
    /*
	switch(iMethodNum)
  {
...
void  CGUID::GetExactValue(CValue & vParam)
{
...
CType   CGUID::GetValueType(void)const
{
	CType tType(100);	
	return tType;
}
...
//void  CGUID::InitObject(CType const & tType)
//{
...
int  CGUID::SaveToString(CString & csStr)
{	
	return 0;
}
...
int  CGUID::GetPropVal(int iPropNum,CValue & rValue)const
{
	return 0;
}

int  CGUID::SetPropVal(int iPropNum,CValue const & vValue)
{
	return 0;
}
