...
int  CHashMap::CallAsFunc(int iMethNum,CValue & rValue,CValue * *ppValue)
{
  switch(iMethNum)
  {
    case funcIsEmpty:
...
int  CHashMap::CallAsProc(int iMethNum,CValue * * ppValue)
{
  switch(iMethNum)
  {
    case procReserve:
...
int  CHashMap::GetParamDefValue(int iMethodNum,int iParamNum,CValue * pDefValue)const
{	
	return 0;
}
...
void  CHashMap::GetExactValue(CValue & vParam)
{
...
CType   CHashMap::GetValueType(void)const
{
	CType tType(100);
...
void  CHashMap::InitObject(CType const & tType)
{
...
int  CHashMap::SaveToString(CString & csStr)
{
	csStr = "DJK";
	return 1;
}
...
int  CHashMap::GetPropVal(int iPropNum,CValue & rValue)const
{
	return -1;
}

int  CHashMap::SetPropVal(int iPropNum,CValue const & vValue)
{
	return -1;
}
