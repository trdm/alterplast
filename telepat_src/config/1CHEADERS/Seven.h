...
enum CAppRunMode
{
	...
	armMONITOR,
	armENTERPRISE
	/*enum CAppRunMode{		// Ñì. CApp7::StartNewProcess
	runEnterprise=-1,
	runConfig=1,
	runDebug=2,
	runMonitor=4
...
enum PageType {ptModule, ptHelp, ptDialog};
...
class CAccContextDef:public CBLContext
{
...
class CAccFormContextDef:public CBLContext
{
...
class CAccListFormContextDef:public CBLContext
{
...
class CAccountContextDef:public CBLContext
{
...
class CApp7:public CAppFrame //CWinApp
{
public:
	DWORD buf[0x300];
public:
...
class CAssistantView:public CFormView
{
...
class CBLModule7: public CBLModule
{
public:
	char buff [0x400];
...
//	void  `default constructor closure'(void);	//322
	...
	virtual void  OnErrorMessageEx(char const *,long,char const *,int);	//1412
...
class CCJContextDef:public CBLContext
{
...
class CCJFormContextDef:public CBLContext
{
...
class CCJPeriodContext:public CBLContext
{
...
class CCJRecordContext:public CBLContext
{
...
class CCalcContextDef:public CBLContext
{
...
class CCheckListBox7:public CListBox
{
...
class CConfigCont:public CContainer
{
...
class CContainerHistory:public CDocument
{
...
class CDocContextDef:public CBLContext
{
...
class CDocEnvironContextDef:public CBLContext
{
...
class CDocFormContextDef:public CBLContext
{
...
class CFormContextDef:public CBLContext
{
...
class CGalleryHolder:public CDocument
{
...
class CGeneralContextDef:public CBLContext
{
...
class CJournalContextDef:public CBLContext
{
...
class CLogFrame:public CChildFrame7
{
...
class CLogView:public CBrowseView
{
...
class CMDataCont:public CContainer
{
...
class CMetaDataStream:public CDocument
{
...
class CModuleCont:public CContainer
{
...
class CMonitorDoc:public CGetDoc
{
...
class CMonitorFrame:public CChildFrame7
{
...
class CMonitorView:public CBrowseView
{
...
class COperContextDef:public CBLContext
{
...
class COperFormContextDef:public CBLContext
{
...
class COperJournalContextDef:public CBLContext
{
...
class CPictureCont:public CContainer
{
...
class CProvJournalContextDef:public CBLContext
{
...
class CRepFormContextDef:public CBLContext
{
...
class CRightsContainer:public CObject
{
public:
...
class CSTInsrtType: public CDialog
{
public:
	char buf[1000];
...
class CSpecPropertyPage:public COlePropertyPage
{
...
class CSrcTemplDocParent:public CDocument
{
...
class CSubcContextDef:public CBLContext
{
...
class CSubcFormContextDef:public CBLContext
{
...
class CSubcItemFormContextDef:public CBLContext
{
...
class CTagDocument:public CDocument
{
...
class CTradeContextDef:public CBLContext
{
...
class CTxtModuleReader:public CDocument
{
...
class CTypedCont:public CContainer
{
...
class CTypedDataCont:public CContainer
{
...
class CTypedTextCont:public CContainer
{
...
class CUserDefCont:public CContainer
{
...
class CWorkBookDoc:public CContainer
{
...
class CXBaseContext:public CBLContext
{
...
class CXBaseKeyContext:public CBLContext
{
...
void __cdecl BookdocsFillOleFileException(class CFileException *,long);
void __cdecl BookdocsThrowOleFileException(long,char const *);
int __cdecl CheckPasswordString(class CString,int,int,char const *);
void __cdecl CorrectCommand(class CString &,class CString &,class CString &);
void __cdecl CorrectCommand(class CString &,class CString &);
class CString  __cdecl CriptPasswordString(char const *);
void __cdecl DefineAccountContext(void);
void __cdecl DefineCalcContext(void);
void __cdecl DefineGeneralContext(void);
void __cdecl DefineTradeContext(void);
int __cdecl DlgDateButton(class CWnd *,unsigned int,class CDate *);
int __cdecl DlgNumericButton(class CWnd *,unsigned int,class CNumeric &,int,int);
void __cdecl FillCombo(class CComboBox *);
void __cdecl ForAll(int (__cdecl*)(class CMetaDataObj *,void *,long &),int (__cdecl*)(unsigned int,void *,long &),void *,long &);
class CString  __cdecl GetContainerDescription(char const *);
int __cdecl GetContextProp(class CBLContext *,class CValue &,class CValue * *);
class CDocType * __cdecl GetGlobalDocType(void);
class CBLModule7 * __cdecl GetGlobalModule(void);
class CString  __cdecl GetLastPPPString(void);
class CString  __cdecl GetModuleFullName(long,char const *,int,class CMetaDataCont *);
int __cdecl GetPasswordString(class CString &,char const *,int);
class CSearchHistoryProfile * __cdecl GetReplaceHistory(void);
class CSplash * __cdecl GetSplashWnd(void);
class CType  __cdecl GetTypeFromValue(class CValue *,int,int,int *,int);
class CString  __cdecl HashPasswordString(char const *);
void __cdecl InitBasicExtContexts(void);
int __cdecl InitGlobalModule(void);
int __cdecl IsAccountContextDefined(void);
int __cdecl IsCalcContextDefined(void);
int __cdecl IsGeneralContextDefined(void);
int __cdecl IsTradeContextDefined(void);
int __cdecl IsTypeAvailable(class CType const &,unsigned int);
int __cdecl IsValid(char const *,char const *);
int __cdecl ModalMode(void);
int __cdecl OnFileCommand(unsigned int,int (__cdecl*)(class CDocument *,long),long);
void __cdecl RT_ActiveBarcodeLicense(void);
class CString  __cdecl ReadStatusLine(void);
void __cdecl ReportEventA(class CString,long,enum EventType,class CString,class CString,class CString);
void __cdecl ReportEventA(class CString,struct LogEventInfo *);
int __cdecl SetContextProp(class CBLContext *,class CValue * *);
int __cdecl SetModalMode(int);
int __cdecl SetTypedValueWithTest(class CTypedValue *,class CValue const *);
int __cdecl TestSetTypedValue(class CType const *,class CValue const *);
void __cdecl UndefineAccountContext(void);
void __cdecl UndefineCalcContext(void);
void __cdecl UndefineGeneralContext(void);
void __cdecl UndefineTradeContext(void);
void __cdecl UndoBasicExtContexts(void);
void __cdecl UndoGlobalModule(void);
void __cdecl WriteStatusLine(unsigned int);
void __cdecl WriteStatusLine(char const *);
long __cdecl atox(char const *);
int __cdecl bin2uue(void const *,int,void *,int);
int __cdecl uue2bin(void const *,int,void *,int);
...
//??_C@_05JNEO@XBASE?$AA@
extern struct _GUID  CLSID_AdminPropPage;
...
extern int  numberCodes;
extern unsigned int *  vkCodes;
extern char const * *  vkNames;
