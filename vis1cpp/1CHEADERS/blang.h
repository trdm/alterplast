...
class CBLModuleProcVarDescr
{
	public:
		...
		char* Name;
		//08h
		int UnknowFlag; // начальное значение?
		//0Ch
		int Flag1;
		//10h
		int Type; // 
...
public:
	...
	void* vtable1;
	//18h
	CPtrArray VarList; //массив ссылок на переменные модуля // CBLModuleProcVarDescr
	//2Ch
	void* vtable2;
	//30h
...
public:
	...
	void* vtable1;
	//04h
	CPtrArray ConstArray; // массив констант в модуле // CBLModuleConstDescr
	//18h
	void* vtable2;
	//1Ch
	CPtrArray ProcArray; // массив ссылок на процедуры модуля // CCompileProcInfo
	//30h
